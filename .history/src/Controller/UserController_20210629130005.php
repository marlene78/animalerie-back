...
class UserController extends AbstractController
{
    ...
    public function create(Request $request, RoleRepository $roleRepository, 
     ValidatorInterface $validator,  SerializerInterface $serializer,UtilisateurRepository $utilisateurRepository  )
    {
        ...
        try {
            ...
            if (count($errors) > 0) {
                ...
                return $this->json($utilisateurRepository->find($utilisateur->getId()),201, ['groups' => ['get:infoUtilisateur']]);
